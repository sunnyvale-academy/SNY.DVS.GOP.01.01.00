# Fork and clone the application repo

In this course we will use a simple application named **java-hello-world** whose sourcecode is hosted here on GitHub.
...
Open your browser and go to: https://github.com/sunnyvale-academy/java-hello-world

The java-hello-world repo home page opens.
...
$ git clone https://github.com/<YOUR GITHUB ACCOUNT>/java-hello-world
```
